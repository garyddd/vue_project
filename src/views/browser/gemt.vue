<template>
  <el-row>
    ...
    <el-col :span="20">
      <browser2 :cate='"GEMT"'></browser2>

      <div class="carousel-type">
        <h2>Human</h2>

        <typeCarouselGemt :species='"Human"'
                      :cate='"GEMT"'></typeCarouselGemt>
      </div>
    </el-col>
    <el-col :span="2"></el-col>
  </el-row>
...
import typeCarouselGemt from '../../components/typeCarouselGemt.vue'
import browser2 from '../../components/browser2.vue'
